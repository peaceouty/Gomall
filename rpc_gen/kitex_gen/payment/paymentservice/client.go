...
func (p *kPaymentServiceClient) ScheduleCancelPayment(ctx context.Context, Req *payment.ScheduleCancelPaymentReq, callOptions ...callopt.Option) (r *payment.ScheduleCancelPaymentResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ScheduleCancelPayment(ctx, Req)
}
