...
func (x *CancelPaymentReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}
...
func (x *ScheduleCancelPaymentReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ScheduleCancelPaymentReq[number], err)
}

func (x *ScheduleCancelPaymentReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.TransactionId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *ScheduleCancelPaymentReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.OrderId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *ScheduleCancelPaymentReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}

func (x *ScheduleCancelPaymentReq) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	x.CancelTime, offset, err = fastpb.ReadInt64(buf, _type)
	return offset, err
}

func (x *ScheduleCancelPaymentResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ScheduleCancelPaymentResp[number], err)
}

func (x *ScheduleCancelPaymentResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Success, offset, err = fastpb.ReadBool(buf, _type)
	return offset, err
}

func (x *ScheduleCancelPaymentResp) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Message, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *CancelPaymentReq) fastWriteField3(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
...
func (x *ScheduleCancelPaymentReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ScheduleCancelPaymentReq) fastWriteField1(buf []byte) (offset int) {
	if x.TransactionId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetTransactionId())
...
func (x *ScheduleCancelPaymentReq) fastWriteField2(buf []byte) (offset int) {
	if x.OrderId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 2, x.GetOrderId())
...
func (x *ScheduleCancelPaymentReq) fastWriteField3(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
	offset += fastpb.WriteUint32(buf[offset:], 3, x.GetUserId())
...
func (x *ScheduleCancelPaymentReq) fastWriteField4(buf []byte) (offset int) {
	if x.CancelTime == 0 {
		return offset
	}
	offset += fastpb.WriteInt64(buf[offset:], 4, x.GetCancelTime())
	return offset
}

func (x *ScheduleCancelPaymentResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ScheduleCancelPaymentResp) fastWriteField1(buf []byte) (offset int) {
	if !x.Success {
		return offset
	}
	offset += fastpb.WriteBool(buf[offset:], 1, x.GetSuccess())
...
func (x *ScheduleCancelPaymentResp) fastWriteField2(buf []byte) (offset int) {
	if x.Message == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 2, x.GetMessage())
...
func (x *CancelPaymentReq) sizeField3() (n int) {
	if x.UserId == 0 {
		return n
	}
...
func (x *ScheduleCancelPaymentReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ScheduleCancelPaymentReq) sizeField1() (n int) {
	if x.TransactionId == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetTransactionId())
...
func (x *ScheduleCancelPaymentReq) sizeField2() (n int) {
	if x.OrderId == "" {
		return n
	}
	n += fastpb.SizeString(2, x.GetOrderId())
...
func (x *ScheduleCancelPaymentReq) sizeField3() (n int) {
	if x.UserId == 0 {
		return n
	}
	n += fastpb.SizeUint32(3, x.GetUserId())
...
func (x *ScheduleCancelPaymentReq) sizeField4() (n int) {
	if x.CancelTime == 0 {
		return n
	}
	n += fastpb.SizeInt64(4, x.GetCancelTime())
	return n
}

func (x *ScheduleCancelPaymentResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ScheduleCancelPaymentResp) sizeField1() (n int) {
	if !x.Success {
		return n
	}
	n += fastpb.SizeBool(1, x.GetSuccess())
...
func (x *ScheduleCancelPaymentResp) sizeField2() (n int) {
	if x.Message == "" {
		return n
	}
	n += fastpb.SizeString(2, x.GetMessage())
...
var fieldIDToName_ScheduleCancelPaymentReq = map[int32]string{
	1: "TransactionId",
	2: "OrderId",
	3: "UserId",
	4: "CancelTime",
...
var fieldIDToName_ScheduleCancelPaymentResp = map[int32]string{
	1: "Success",
	2: "Message",
}
