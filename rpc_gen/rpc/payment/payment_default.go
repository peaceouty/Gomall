...
func ScheduleCancelPayment(ctx context.Context, req *payment.ScheduleCancelPaymentReq, callOptions ...callopt.Option) (resp *payment.ScheduleCancelPaymentResp, err error) {
	resp, err = defaultClient.ScheduleCancelPayment(ctx, req, callOptions...)
	if err != nil {
		klog.CtxErrorf(ctx, "ScheduleCancelPayment call failed,err =%+v", err)
		return nil, err
	}
	return resp, nil
}
