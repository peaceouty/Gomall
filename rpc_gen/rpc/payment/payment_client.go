...
type RPCClient interface {
	...
	ScheduleCancelPayment(ctx context.Context, Req *payment.ScheduleCancelPaymentReq, callOptions ...callopt.Option) (r *payment.ScheduleCancelPaymentResp, err error)
}
...
func (c *clientImpl) ScheduleCancelPayment(ctx context.Context, Req *payment.ScheduleCancelPaymentReq, callOptions ...callopt.Option) (r *payment.ScheduleCancelPaymentResp, err error) {
	return c.kitexClient.ScheduleCancelPayment(ctx, Req, callOptions...)
}
